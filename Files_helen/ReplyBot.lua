...
if not database:get(bot_id..'Helen:Reply:Mute'..msg.chat_id_) then
...
database:del(bot_id..'Helen:Reply:Mute'..msg.chat_id_)
...
database:set(bot_id..'Helen:Reply:Mute'..msg.chat_id_,true)
